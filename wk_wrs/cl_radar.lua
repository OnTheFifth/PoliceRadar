    ...
    if ( IsPedSittingInAnyVehicle( ped ) ) then 
        ...
        if ( GetVehicleClass( vehicle ) == 18 ) then
            ...
            if ( radarEnabled ) then 
                exports['Notif'].bitchMade('', 'Radar Enabled')
            else 
                exports['Notif'].bitchMade('', 'Radar Disabled')
            end 
            ...
            exports['Notif'].DoCustomHudText('', 'You are not a police vehicle dumbass')
        end 
    else 
        exports['Notif'].DoCustomHudText('', 'Trying to use a radar without vehicle LuL')
    end 
end )
...
function ToggleSpeedType()
    if ( radarInfo.speedType == "mph" ) then 
        ...
        exports['Notif'].DoCustomHudText('', 'Speed in Km/h ???? Change it idiot')
    else 
        radarInfo.speedType = "mph"
            exports['Notif'].DoCustomHudText('', 'Nice you are checking speed in MPH')
    end
end 
